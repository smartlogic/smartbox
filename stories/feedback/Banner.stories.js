...
import { Banner } from '@smartlogic/smartbox';
...
export default storiesOf('Feedback|Banner', module)
  ...
  .add('Warning', withInfo()(() => (
    <Banner title='New IPs need to be warmed up' status='warning' >
      Please read the <a href="https://support.smartlogic.io/customer/portal/articles/1972209-ip-warm-up-overview" target="_blank">IP Warm-up Overview article</a> for more information.
    </Banner>
  )))
  ...
  .add('Danger', withInfo()(() => (
      <Banner
        ...
        <p>If you have questions about your account, please contact us at billing@smartlogic.io.</p>
      </Banner>
  )));
